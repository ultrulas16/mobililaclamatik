...
export default function CompanyDashboard() {
  ...
  const menuItems = [
    ...
    { icon: Calendar, label: 'Ziyaretler', route: '/company/services', color: '#06b6d4', gradient: ['#06b6d4', '#0891b2'] },
    { icon: FileText, label: 'Hizmet Raporları', route: '/company/service-reports', color: '#ec4899', gradient: ['#ec4899', '#db2777'] },
